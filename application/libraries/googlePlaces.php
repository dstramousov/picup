...
class googlePlaces
{
	...
	public function __construct($apiKey = 'AIzaSyBGw5s0tNhuv4dXc3lP0PD19bkqkWtOaJE')
	{
		$this->_apiKey = $apiKey;	
	}
	...
	protected function _apiCall()
	{
		...
		if($this->_apiCallType=="search") {
			...
			$URLparams = "location=".$this->_location."&radius=".$this->_radius."&language=".$this->_language."&name=".$this->_name."&sensor=".$this->_sensor;
		}
